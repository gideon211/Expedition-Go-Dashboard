...
export default function ConversationList({ conversations, selectedId, onSelect, loading, currentUserId }) {
  if (loading) {
    return (
  ...
  if (conversations.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center px-4">
        ...
        <p className="mt-1 text-xs text-gray-400">Messages from admin will appear here</p>
      </div>
    );
  }
